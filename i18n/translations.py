...
pt_BR: Dict[Tuple[str, str], str] = {
    ...
    ("*", "Versions"): "VersÃµes",
    ("*", "Versions:"): "VersÃµes:",
    ("*", "Last publish"): "Ãšltima publicaÃ§Ã£o",
    ("*", "WIP"): "WIP",
    ...
    ("*", "Addon is not active"): "O addon nÃ£o estÃ¡ ativo",
    ("*", "Settings not initialized"): "ConfiguraÃ§Ãµes nÃ£o inicializadas",
    ("*", "Error loading interface"): "Erro ao carregar interface",
    
    # Roles
    ("*", "Animation"): "AnimaÃ§Ã£o",
    ("*", "Layout"): "Layout",
    ("*", "Lightning"): "IluminaÃ§Ã£o",
    ("*", "Assembly"): "Assembly",
    ("*", "Roles"): "Cargos",
    ("*", "Roles:"): "Cargos:",
    ...
    ("*", "Single Scene"): "Cena Ãšnica",
    ("*", "Create a single scene without numbering"): "Criar uma cena Ãºnica sem numeraÃ§Ã£o",
    ("*", "Shot Number"): "NÃºmero do Shot",
    ("*", "Scene Name"): "Nome da Cena",
    ("*", "Your Role"): "Seu Cargo",
    ("*", "Select your role for this shot"): "Selecione seu cargo para este shot",
    ("*", "Role Settings"): "ConfiguraÃ§Ãµes de Cargo",
    ("*", "No project selected."): "Nenhum projeto selecionado.",
    ("*", "Role '{}' not configured in preferences."): "Cargo '{}' nÃ£o configurado nas preferÃªncias.",
    ("*", "Shot already exists: {}"): "Shot jÃ¡ existe: {}",
    ("*", "Error creating WIP version"): "Erro ao criar versÃ£o WIP",
    ("*", "Shot created and WIP file saved at: {}"): "Shot criado e arquivo WIP salvo em: {}",
    ("*", "Error creating shot: {}"): "Erro ao criar shot: {}",
    ("*", "Configure the following preferences first: {}"): "Configure as seguintes preferÃªncias primeiro: {}",
    ("*", "Please select or create a project first."): "Por favor, selecione ou crie um projeto primeiro.",
    ("*", "Add Default Role"): "Adicionar Cargo PadrÃ£o",
    ("*", "New role description"): "DescriÃ§Ã£o do novo cargo",
    ("*", "Remove Default Role"): "Remover Cargo PadrÃ£o",
    ("*", "Move Default Role"): "Mover Cargo PadrÃ£o",
    ("*", "Direction"): "DireÃ§Ã£o",
    ("*", "Direction to move the role"): "DireÃ§Ã£o para mover o cargo",
    ("*", "Up"): "Para Cima",
    ("*", "Down"): "Para Baixo",
    # Assembly Management
    ("*", "Assembly:"): "Assembly:",
    ...
    ("*", "Purge Unused Data"): "Limpar Dados NÃ£o Utilizados",
